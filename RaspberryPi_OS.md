...
**Moode Audio Player / MoodeOs** *from source*

	Source only, to build on Raspbian. MPD client, forked Volumio Webui, frequently update, upnp renderer
	
* http://moodeaudio.org/

***

**PiCoreplayer** 3.5.0 	2018-03-24
...
**Roon Bridge output** *Roon is commercial*
    ...
    Raspbian base?
	Roon pricing: 119 $/year or 499 $ Lifetime, 15 days free trial (registration with credit card)
...
* https://download.fedoraproject.org/pub/fedora/linux/releases/27/Workstation/armhfp/images/
* https://download.fedoraproject.org/pub/fedora/linux/releases/27/Server/armhfp/images/
